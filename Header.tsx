...
export const Header: React.FC<HeaderProps> = ({
  ...
  const handleSocialLogin = (provider: string) => {
    setUserEmail(`developer@${provider.toLowerCase()}.com`);
    setIsLoggedIn(true);
    setIsLoginModalOpen(false);
  };
          ...
          {isLoggedIn ? (
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span className="hidden sm:inline max-w-[110px] truncate">{userEmail}</span>
              </button>
            </div>
          ) : (
            <button
                ...
                <div className="space-y-4 text-xs">
                  <div className="p-4 bg-slate-950 border border-slate-800 rounded-2xl space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-cyan-400 font-mono">{userEmail}</span>
                    </div>
                    <div className="flex items-center justify-between">
                ...
                <div className="space-y-4 text-xs">
                  ...
                  <form onSubmit={handleLoginSubmit} className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-[11px] pt-1">
                      ...
                      <button
                        type="button"
                        onClick={() => alert(isAr ? 'تم إرسال رابط إعادة تعيين كلمة المرور إلى بريدك الإلكتروني.' : 'Password reset link sent to your email.')}
