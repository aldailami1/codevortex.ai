...
export const AboutUsPage: React.FC<AboutUsPageProps> = ({ language, onSelectView }) => {
  ...
  const values = [
    ...
    },
    {
      ...
      descAr: 'صممنا بيئة CloudForge لتكون الأسرع في التشغيل والتنفيذ المباشر على المنفذ 3000.',
      ...
      <div className="max-w-5xl mx-auto space-y-16">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-950/80 border border-cyan-800 text-cyan-400 text-xs font-black">
            ...
            <span>{isAr ? 'قصة وسالة منصة CloudForge' : 'Our Story & Mission'}</span>
          </div>
          ...
          <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
            {isAr
              ? 'تأسست منصة CloudForge بهدف واضح: إلغاء التعقيدات البرمجية وإتاحة بيئة تطوير سحابية شاملة تعتمد على الذكاء الاصطناعي، لتتيح للمطورين والشركات تحويل أفكارهم إلى برمجيات حقيقية في دقائق.'
              : 'CloudForge was born to eliminate software friction. We combine real-time REPL environments with neural AI agents to let creators deploy apps in minutes.'}
          </p>
        </div>
