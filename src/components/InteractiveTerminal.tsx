...
export const InteractiveTerminal: React.FC<InteractiveTerminalProps> = ({
  ...
  const [logs, setLogs] = useState<TerminalLog[]>([
    {
      id: '1',
      type: 'info',
      text: 'CloudForge Neural Cloud Kernel v5.2.0-release',
  ...
  const handleCommandSubmit = (e: React.FormEvent) => {
    ...
    if (lower === 'help') {
      ...
      responseLogText = '🟢 Dev Server: RUNNING | Port: 3000 | Memory: 42MB | Node: v20.11.0 | Engine: CloudForge Neural v5';
      responseType = 'success';
      ...
      <div className="bg-slate-900 border-b border-slate-800 px-4 py-2 flex items-center justify-between gap-2 shrink-0 select-none">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-slate-200 text-[11px] tracking-tight">
            {isAr ? 'منصة الأوامر والشل (CloudForge Shell v5)' : 'CloudForge Cloud Shell v5.0'}
          </span>
