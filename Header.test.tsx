...
import { Project, ViewMode, Language } from '../types';
...
describe('Header Component', () => {
  it('renders platform brand and view options', () => {
    ...
    expect(screen.getAllByText('CodeVortex')).toBeTruthy();
  });
  ...
  it('allows changing language when language button clicked', () => {
    ...
    const langButton = screen.getByTitle(/Change Language/i) || screen.getByText(/EN/i);
