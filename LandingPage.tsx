...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  const codeLines = [
    ...
    `const app = createAgent({ model: 'cf-neural-v5', rtl: ${isAr ? 'true' : 'false'} });`,
  ...
  const faqs = [
    ...
    {
      q: isAr ? 'ما انواع التطبيقات التي يمكنني بناؤها باستخدام CloudForge؟' : 'What types of applications can I build using CloudForge?',
      a: isAr
          ...
          <div className="relative w-20 h-20 sm:w-24 sm:h-24 flex items-center justify-center shrink-0">
            ...
            <div className="relative w-full h-full rounded-3xl bg-[#090e1a] border border-cyan-400/40 shadow-[0_0_40px_rgba(0,242,254,0.3)] flex items-center justify-center p-3">
              <svg className="w-full h-full text-[#00F2FE]" viewBox="0 0 100 100" fill="none">
                <defs>
                  <linearGradient id="cloudForgeHeroGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <path
                  ...
                  stroke="url(#cloudForgeHeroGrad)"
                  strokeWidth="8"
                  strokeLinecap="round"
                />
                <circle cx="50" cy="50" r="12" fill="url(#cloudForgeHeroGrad)" />
              </svg>
            </div>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl font-mono text-xs">
            ...
            <div className="bg-slate-950 px-4 py-3 border-b border-slate-800 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="ml-2 text-slate-400 text-[11px] font-sans font-bold">cloudforge-interactive-repl-sandbox</span>
              </div>
              ...
              {activeTabDemo === 'agent' && (
                <div className="space-y-4">
                  <div className="flex items-center gap-3 text-cyan-400 font-bold">
                    ...
                    <span>[CloudForge Neural v5.0] - Stream Output Active:</span>
                  </div>
